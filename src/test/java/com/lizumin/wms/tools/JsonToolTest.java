...
public class JsonToolTest {
    ...
    private static String userJson = "{\"id\":1,\"password\":\"12346\",\"username\":null,\"enabled\":true,\"accountNonExpired\":true,\"accountNonLocked\":true,\"credentialsNonExpired\":true,\"authorities\":[{\"@class\":\"com.lizumin.wms.entity.SimpleAuthority\",\"authority\":\"ROLE_ADMIN\"},{\"@class\":\"com.lizumin.wms.entity.SimpleAuthority\",\"authority\":\"READ_ONLY\"}]}";

    @BeforeAll
    public static void setUp(){
        Set<GrantedAuthority> authorities = new HashSet<>(2);
        authorities.add(new SimpleAuthority("ROLE_ADMIN"));
        authorities.add(new SimpleAuthority("READ_ONLY"));
